...
const SYSTEM_PROMPT = `You are SGnexasoft AI Assistant — a helpful, friendly assistant for the SGnexasoft freelance platform built by Ganesh Jalla. Help users with: posting projects (CLIENT role), placing bids (STUDENT role), payment/escrow system, submitting work, messaging, and navigating the platform. Keep answers concise, friendly, and practical. Always end responses with a helpful tip when relevant.`;
...
export default function AIChatBot() {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: `Hi ${user?.name?.split(' ')[0] || 'there'}! 👋 I'm the SGnexasoft AI Assistant. How can I help you today?`
    }
  ]);
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          color: '#fff', cursor: 'pointer', boxShadow: '0 8px 24px rgba(99,102,241,0.5)',
      ...
      {open && (
        <div style={{
          ...
          width: 360, height: 500, background: '#fff', borderRadius: 20,
          boxShadow: '0 24px 60px rgba(0,0,0,0.18)', display: 'flex',
          ...
          <div style={{
            ...
            fontSize: 10, color: '#94a3b8', borderTop: '1px solid var(--border)'
          }}>
